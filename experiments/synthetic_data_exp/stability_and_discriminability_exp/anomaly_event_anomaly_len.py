...
anomaly_point_len_max = 2000+1

separate_point = 100

step_after = 100

anomaly_point_list = list(range(1, separate_point + 1)) \
       + list(range(separate_point + step_after, anomaly_point_len_max, step_after))

json_file_name = "event_anomaly_coverage_anomaly_point_len"

for anomaly_point_len in anomaly_point_list:
    ...
    file_path = dataset_dir + "synthetic_exp_result/single_res/anomaly_len/synthetic_data_res_" + str(anomaly_point_len) + "_" + json_file_name + ".json"
    ...
    # last is full detection
    upper_limit_line = new_res_data[-1]

    upper_limit_x.append(anomaly_point_len)
...
res_save_dir = dataset_dir + "synthetic_exp_result/exp_res_data/" + "synthetic_exp_res_" + str(anomaly_point_len_max) + "_"+ json_file_name + ".json"
