...
anomaly_ratio_min = 0.0001 # 0.1%
anomaly_ratio_max = 0.01 # 10%

json_file_name = "event_anomaly_coverage_anomaly_ratio"

ratio_num = 101

vals = np.linspace(anomaly_ratio_min, anomaly_ratio_max, ratio_num)

for anomaly_ratio in vals:
    # round
    ...
    file_path = dataset_dir + "synthetic_exp_result/single_res/anomaly_ratio/synthetic_data_res_" + str(anomaly_ratio) + "_" + json_file_name + ".json"
    ...
    upper_limit_x.append(anomaly_ratio)
...
res_save_dir = dataset_dir + "synthetic_exp_result/exp_res_data/" + "synthetic_exp_res_" + str(ratio_num) + "_"+ json_file_name + ".json"
