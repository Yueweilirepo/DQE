...
exclude_ad_pool = ['NORMA', 'Series2Graph', 'Lag_Llama', 'TimesFM', 'Chronos', 'MOMENT_ZS',
                   'MOMENT_FT'] + ["AnomalyTransformer","OFA"] + ["Donut"] + ["KShapeAD","Left_STAMPi","MatrixProfile","SAND","TimesNet","TranAD"]

all_ad_pool = Unsupervise_AD_Pool + Semisupervise_AD_Pool
