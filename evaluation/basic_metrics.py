...
class basic_metricor():
    ...
    def RangeAUC_volume_opt(self, labels_original, score, windowSize, thre=250):
        ...
        for window in window_3d:
            ...
            # # [(2014, 2147), (3328, 3461), (3956, 4030)]
            # check_point_range_list = []
            # for range_extend_check in L:
            #     check_point_range  = labels_extended[range_extend_check[0]-1:range_extend_check[1]+2]
            #     check_point_range_list.append(check_point_range)
